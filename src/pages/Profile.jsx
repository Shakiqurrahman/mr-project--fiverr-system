...
function Profile() {
    ...
    return (
        <section className="my-20 max-w-[500px] flex flex-col items-center mx-auto rounded-2xl p-10 border shadow-xl">
            ...
            <h2 className="mt-2 text-xl font-semibold ">{userData.fullName || "John Doe"}</h2>
            <p className="text-sm mb-1 text-primary">{userData.country || "San Francisco, California"}</p>
            <p className="text-[15px] font-medium">Email: {userData.email || "test@gmail.com"}</p>
        </section>
    );
}
