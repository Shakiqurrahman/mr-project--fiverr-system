...
function UploadDesign() {
  ...
  const designs = ["Door Hanger Design", "Door Hanger Design", "Postcard Design", "Business Card Design"];
  ...
  const [availableSubcategories] = useState({
    1: [
  ...
  useEffect(() => {
    if (form.category) {
      setSubcategories(availableSubcategories[form.category] || []);
    } else {
      setSubcategories([]);
    }
  }, [form.category]);
          ...
          <div className='p-3'>
            ...
            <div className='flex gap-2 mt-5'>
              <div className='w-full'>
                ...
                <div className='bg-white flex flex-wrap gap-2 h-12 items-center w-full p-2 border border-solid border-[#e7e7e7] mt-3 outline-none'>
