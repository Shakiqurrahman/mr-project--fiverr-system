      ...
      <div className="ml-5">
        ...
        <ul className="ml-10 list-disc marker:text-xl marker:text-revision">
          <li>
            ...
            <p className="mb-10 mt-3">
              There are different folders in each design box, and each folder is
              for different industry designs, you can find the folder you need
              by clicking the &quot;Arrow Icon&quot; in the box, or you can see
              all the folders together by clicking &quot;See More&quot; on the
              top right side of the box.
            </p>
          </li>
        </ul>
        <ul className="ml-20 list-disc marker:text-xl marker:text-revision">
          <li>
            ...
            <div className="mb-10 mt-3">
              ...
              title below each design and click on the selected industry to view
              the designs within the folder.
              <p>
      ...
      <div className="ml-5">
        <ul className="list-disc marker:text-xl marker:text-revision">
          <li>
            ...
            <p className="mb-10 mt-3">
              You can search for the design you need from the search box of the
              top bar.
            </p>
          </li>
        </ul>
        ...
        <ul className="list-disc marker:text-xl marker:text-revision">
          <li>
            ...
            <div className="mb-10 mt-3">
              ...
              select your specific or similar industry tag, and then select the
              design tag you need. Then see your selected designs below.
              <p>
                (if you don&apos;t find your preferred design please inbox us)
              </p>
            </div>
        ...
        <ul className="list-disc marker:text-xl marker:text-revision">
          <li>
            ...
            <p className="mb-10 mt-3">
              ...
              &quot;Completed Projects&quot;, from there you can see some of our
              previous completed project designs.
            </p>
          </li>
        </ul>
      </div>
