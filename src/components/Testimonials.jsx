...
function Testimonials() {
  ...
  useEffect(() => {
    ...
    const attractiveWords = [
      ...
      "highly recommended",
      "loved",
      "Great Work, very professional, efficient work, great job, good job, Highly Recommend, 100% recommend, 5 stars, Quick response, fast delivery, great experience, responsible, Very responsive, Easy process, good communication, great result, definitely recommend, satisfied, Amazing work, fast work, amazing job, I’m so happy, I’m very happy, Amazing person, wonderful job, professional designer, won’t be disappointed, excellent experience, quick work, Quick reply, fast turn around, Quick service, unique design, looks professional, Quick delivery, Great communication, He's the best, Always great service, Top quality designs, professionalism, Fast service, efficient service, Very professional work, always happy, Very creative, easy to work with, Easy to communicate with, very understanding, Exceeded my expectation, Revised all details requested, Great seller, Very convenient, timely, Excellent work, professional skills, very patient, Awesome, Awesome job, Never disappoints, Did amazing, Beautiful design, Mahfujurrahm535, MR, Wonderful work, Very nice work, good work, good experience, look amazing, very good, Fantastic, Fantastic work,"
    ];
